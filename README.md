...
A community Discord bot(vibecoded) with scams detection, and "funny" features.
...
Set the bot token via environment variable:
...
Keys can be set directly in the database:
...
3. The command handler auto-loads it on next restart.
